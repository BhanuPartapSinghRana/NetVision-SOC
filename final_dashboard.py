...
st.set_page_config( 
    page_title="NetVision SOC", 
    page_icon="   ", 
    layout="wide", 
    initial_sidebar_state="expanded" 
)
# ui_render.py — Professional NetVision UI (imported by main dashboard) 
...
/* ── Hide Theme Switcher & Toolbar ── */
[data-testid="stToolbar"], [data-testid="stDecoration"], [data-testid="stHeader"], #MainMenu, footer {
    visibility: hidden;
    display: none;
}
...
unsafe_allow_html=True) 
        ...
        st.caption("NetVision v3.0 · Inter font · Plotly charts") 
...
def render_main(dashboard, stats): 
    ...
    <div class="brand-bar"> 
        <div> 
            <div class="brand-title">    NetVision SOC</div> 
...
class ThreatDetector: 
    ...
    def load_model(self) -> bool: 
        ...
        try: 
            ...
            print(f"[OK] NetVision model loaded successfully from {self.model_path}") 
            return True 
